...
return [
    ...
    */
    ...
    "between"          => [
        ...
        "file"    => ":attribute のファイルサイズは :min  kBから :max  kBまでとなります。",
    ...
    "max"              => [
        ...
        "file"    => ":attribute のサイズが :max  kB以下のファイルを指定してください。",
    ...
    "min"              => [
        ...
        "file"    => ":attribute のファイルサイズは :min  kB以上までとなります。",
    ...
    "size"             => [
        ...
        "file"    => ":attribute のファイルサイズは :size  kBと一致しません。",
